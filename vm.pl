...
my @main = 
    (MCVM::Instructions::PUSH.new( value => 2 ), MCVM::Instructions::PUSH.new( value => 13)),
    (MCVM::Instructions::LOAD.new( label => '&mul'), MCVM::Instructions::CALL.new),
    (MCVM::Instructions::OUT.new),
;
